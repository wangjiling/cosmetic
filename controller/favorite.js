...
var favoriteData = require('../mockupdata/favorite.json');
...
//                console.log('getFavoriteList' + JSON.stringify(data));
//				favorList = data;
//				renderFun(req,res,{
//					title:'我的收藏',
...
//    }
    ...
    renderFun(req,res,{
        title:'我的收藏',
        favorListData:favoriteData.getFavoriteList
    },'favor_list');
};
//添加收藏
...
//            console.log('addFavor' + JSON.stringify(data));
...
//    }
    ...
    renderFun(req,res,favoriteData.addFavor);
};
//取消收藏
...
//            console.log('delFavor' + JSON.stringify(data));
//            renderFun(req,res,data);
//        });
//    }catch(err){
//        console.log("call back error : " + JSON.stringify(err));
//    }
    ...
    renderFun(req,res,favoriteData.delFavor);
};